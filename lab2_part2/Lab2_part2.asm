...
elif1:
	...
	#  n = 110 a 10 b 
	li 	$t4, 0xC000			#  load 1100000000000000 in front
	or 	$s2, $t4, $t3			#  add a to n 
	li 	$t4, 0x80			#  load 10000000  
...
elif3:
	...
	li 	$t6, 0xF0000000			# load 1111000000000000000000000000 to front of n
	...
	or	$s2, $s2, $t6			# add (1000000 or d) to n
	j 	end_if
else:						#  else
